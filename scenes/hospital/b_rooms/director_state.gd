...
@onready var lebron: CharacterBody2D = $FinalDirector
@onready var hitbox_area   : Area2D = $FinalDirector/enemy_hitbox        # adjust if different
@onready var detect_area   : Area2D = $FinalDirector/detection_area      # adjust if different
@onready var hitbox_shape  : CollisionShape2D = $FinalDirector/enemy_hitbox/CollisionShape2D
@onready var detect_shape  : CollisionShape2D = $FinalDirector/detection_area/CollisionShape2D
